...
import { EnergyMixChartLine } from '../../ui/components/organisms/EnergyMixChartLine';
...
describe('EnergyMixChartLine', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });

  it('debería renderizar el gráfico correctamente', () => {
    const { container } = render(<EnergyMixChartLine data={testData} />);
  ...
  it('debería pasar los datos correctos al gráfico', () => {
    render(<EnergyMixChartLine data={testData} />);
